...
func Texpr_StructOfPrimitives() goadl.ATypeExpr[StructOfPrimitives] {
	return goadl.ATypeExpr[StructOfPrimitives]{
...
func init() {
	goadl.RESOLVER.Register(
		adlast.ScopedName{ModuleName: "exer01.simple_struct", Name: "StructOfPrimitives"},
